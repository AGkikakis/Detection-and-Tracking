function dvisualise( frames, stats, gtpositions, loop, fps, diss )
...
if nargin < 5, fps = 9; end
if nargin < 6, diss = length(frames); end
...
%             r = stats(i,c).Radius;
            ...
            for j=max(2, i-diss):i,
                line([gtpositions(c,j-1,1), ...
                    gtpositions(c,j,1)], ...
                    [gtpositions(c,j-1,2), ...
                    gtpositions(c,j,2)], ...
                    'Color', color(c), 'LineWidth',2); 
            end
            viscircles([gtpositions(c,i,1), gtpositions(c,i,2)],r, ...
                'EdgeColor', color(c));
        end
        hold off;
